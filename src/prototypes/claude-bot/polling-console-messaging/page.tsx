...
export default function PollingConsoleMessaging() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-bg-secondary p-6 gap-4">
      {/* Header */}
      <div className="max-w-4xl w-full mx-auto">
        <h1 className="text-xl font-semibold text-text-primary">Polling Console</h1>
      ...
      <div className="max-w-4xl w-full mx-auto flex items-center gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <span className="text-xs text-text-tertiary">Interval:</span>
        ...
        <div className="flex items-center gap-2">
          <span
            className={cn(
              ...
              isPolling ? "bg-green-400 animate-pulse" : "bg-text-tertiary"
            )}
          />
      ...
      {/* Console */}
      <div className="max-w-4xl w-full mx-auto flex-1 bg-[#0d1117] rounded-xl border border-border overflow-hidden font-mono text-xs shadow-card">
        <div className="flex items-center gap-1.5 px-4 py-2.5 bg-[#161b22] border-b border-border">
          <span className="w-3 h-3 rounded-full bg-red-500/70" />
          <span className="w-3 h-3 rounded-full bg-yellow-500/70" />
          <span className="w-3 h-3 rounded-full bg-green-500/70" />
          <span className="ml-3 text-text-tertiary text-[11px]">polling-console — output</span>
        </div>

        <div className="h-[480px] overflow-y-auto p-4 space-y-1 scrollbar-thin">
          {logs.length === 0 ? (
            <p className="text-text-tertiary italic pt-2">
      ...
      {/* Footer stats */}
      <div className="max-w-4xl w-full mx-auto flex gap-4 text-xs text-text-tertiary">
